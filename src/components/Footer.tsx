        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/legal/terms" className="text-gray-600 hover:text-primary transition-colors text-sm">
                  Términos y Condiciones
                </Link>
              </li>
              <li>
                <Link to="/legal/privacy" className="text-gray-600 hover:text-primary transition-colors text-sm">
                  Política de Privacidad
                </Link>
              </li>
              <li>
                <Link to="/legal/cookies" className="text-gray-600 hover:text-primary transition-colors text-sm">
                  Política de Cookies
                </Link>
              </li>
              <li>
                <Link to="/legal/legal-notice" className="text-gray-600 hover:text-primary transition-colors text-sm">
                  Aviso Legal
                </Link>
              </li>
              <li>
                <Link to="/legal/service-level-agreement" className="text-gray-600 hover:text-primary transition-colors text-sm">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/help" className="text-gray-600 hover:text-primary transition-colors text-sm">
                  Centro de Ayuda
                </Link>
              </li>
              <li>
                <Link to="/help/guide" className="text-gray-600 hover:text-primary transition-colors text-sm">
                  Guía de Usuario
                </Link>
              </li>
              <li>
